...
\begin{tikzpicture}[]
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \begin{axis}[name=zdump, scale=0.7,
            ...
            xshift=0.5cm, anchor=left of north west,
            xmin=0, xmax=\zxmax,
            ymin=0, ymax=\zymax,
            xlabel=$z$, ylabel=$P$,
            axis lines=left,
    ...
    \draw[orange, dashed, ->, >=Stealth] 
        ([shift={(0.1cm,0)}]righto.east) --++ (0.5cm,0) |-
    ...
    \begin{pgfonlayer}{background}
        \draw[fill=orange!20, rounded corners]
            ([shift={(2pt, -2pt)}]CONSBOX.north east |- CONSHEAD.south east) --
                % node (CONSNUM) {} --
            ([shift={(0, -2pt)}]CONSBOX.north west |- CONSHEAD.south west)
                node (CONSNUM) {} --
            (CONSBOX.south west) --
            ([shift={(2pt, 0pt)}]CONSBOX.south east) --
            cycle ;
