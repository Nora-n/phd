...
\begin{figure}[htbp]
    \vspace*{-2.7cm}
    \centerfloat
    \includegraphics[width=1.1\linewidth]{mass_model_all_evol-small.pdf}
    ...
    \end{tabular}}
        \begin{tablenotes}[flushleft]
            \item \small \textbf{\hspace{-3,2pt}Notes.} Pour chaque simulation,
                ...
                donnée par rapport au meilleur modèle (BP), telle que
...
\begin{figure}[p]
    ...
    \centerfloat
    \includegraphics[width=.95\linewidth]{FULL-SNFSUPP_all_RS-MS_kernels}
