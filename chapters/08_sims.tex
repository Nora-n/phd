...
\begin{figure}[]
    ...
    \caption[Marche de magnitude des SNe~Ia en fonction du traceur]{Marche de
        ...
        de~\cite{briday2021}. Selon la capacité des traceurs à distinguer les
        populations de SNe~Ia (traduit par leur contamination), la marche de
        magnitude trouvée varie. En prenant le LsSFR comme traceur de référence
        avec $\gamma = \SI{0.13}{mag}$, la masse globale donnerait une marche de
    magnitude autour de \SI{0.10}{mag}.}
    \label{fig:briday_steps}
\end{figure}
