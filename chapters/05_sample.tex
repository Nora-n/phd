...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.95\linewidth]{stretchs-cut_btw_sup_hist_ztf_x1}
    \caption[Présentation des données d'étirement en fonction du redshift pour
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.95\linewidth]{stretchs-cut_btw_hist_stac_ztf_x1}
    \caption[Présentation des données d'étirement en fonction du redshift pour
