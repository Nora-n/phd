...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{stretchevol_all-oth_vs_snf-mean.pdf}
    ...
    utilisé]{Évolution de l'étirement moyen ($x_1$) des SNe~Ia issus d'un
        ...
        base. Les marqueurs montrent la simple moyenne de l'étirement (les
        ...
        Les meilleurs ajustements de notre modèle de dérive de base sont
    ...
    l'ensemble de données fiduciel. Les lignes verte et violette représentent
les meilleurs ajustements d'autres modèles dérivants, voir
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{bbc_comp_PS1_hist-nr_viridis.pdf}
...
\section{Prédictions et amélioration}\label{sec:xpred}
